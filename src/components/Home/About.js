  ...
  const aboutText =
    language === "en"
      ...
      : {
          ...
          paragraph2:
            "J’ai ainsi décidé de changer radicalement de vie et de me consacrer à cette passion. J’ai commencé à pratiquer en parallèle d'emplois dans d'autres domaines, ce qui m'a demandé un changement radical et une grande concentration. Cela m’a permis d’acquérir une expérience précieuse sur divers projets de développement. Dès lors, j'ai mis tout en oeuvre pour apprendre et réussir dans cette voie.",
          paragraph3:
            "En Janvier 2023, j'ai décidé de me lancer et d'en faire mon métier en passant le diplôme Bac+2 de Developpeur Web et Web mobile 'Full Stack', que j'ai obtenu en Février 2024. Après ce succès, le formateur React et Javascript de l'école m'a offert la superbe opportunité de réaliser un stage de plusieurs mois en Full remote chez Andragogy pour l'aider à développer une application dans le secteur de la formation personnalisée accompagnée par l'intelligence artificielle destinée aux entreprises et aux écoles. J’ai travaillé en étroite collaboration avec l'équipe de l’UX/UI design pour réaliser le Front-end, tout en travaillant en binôme avec mon ancien formateur sur la partie Back-end.",
          paragraph4:
...
// ###### TODO : AJOUTER LIEN VERS PROJETS & ANDRAGOGY / AMELIORER L'IMAGE / AJOUTER LA POSSIBILITE DE CONSULTER LE DIPLÔME ET LE CV ######
